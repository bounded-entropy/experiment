...
siteschema names the sites a delta may attach to; adapters/ holds one
registered adapter type per file plus both of its lowerings; compile lowers a
bank into the bundle, the only data channel back from the training world.
"""
